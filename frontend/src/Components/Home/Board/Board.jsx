...
function Board({
  ...
  return (
    <div className='w-[300px] xsm:w-[350px] sm:w-[385px] justify-center items-center bg-white shadow-lg rounded-lg flex flex-col relative'>
      <div className='w-full p-4 justify-start flex flex-col'>
        ...
        >
          <h4
            className='max-w-[87%] unselectable text-4xl mb-3 text-gray-700 break-words min-w-0 whitespace-nowrap truncate'
            unselectable='on'
          >
            {name}
          </h4>
